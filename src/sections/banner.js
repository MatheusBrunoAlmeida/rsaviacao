...
import BannerImage from 'assets/banner-image-1.jpeg';
          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              <Box sx={styles.banner.stars}>
                ...
                <FaStar />
                <FaStar />
                A melhor avaliação em cursos
              </Box>
              <Heading as="h3">
                Aprenda Aeronáutica <br />
                com Raffael Santos
              </Heading>
              <Text as="p">
                Somos uma escola de aviação civil especializada em Ensino Aeronáutico à distância.
                Voe cada vez mais alto no conhecimento aeronáutico conosco!
              </Text>
              <Box>
                <Button css={{background: '#f3b33f', color: 'white'}}>
                  Começar a aprender
                </Button>
              </Box>
